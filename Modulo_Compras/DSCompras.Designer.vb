...
<System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 System.Xml.Serialization.XmlRootAttribute("DSCompras"),  _
...
Partial Public Class DSCompras
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSCompras.xsd"
    ...
    Partial Public Class ordencomprampDataTable
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddordencomprampRow(ByVal fecharealizacion As Date, ByVal idordencompra As Integer, ByVal idproveedor As Integer, ByVal Expr1 As Integer, ByVal nombre As String, ByVal plazodeentrega As Date, ByVal condicionesdepago As String) As ordencomprampRow
            Dim rowordencomprampRow As ordencomprampRow = CType(Me.NewRow,ordencomprampRow)
            rowordencomprampRow.ItemArray = New Object() {fecharealizacion, idordencompra, idproveedor, Expr1, nombre, plazodeentrega, condicionesdepago}
            Me.Rows.Add(rowordencomprampRow)
            Return rowordencomprampRow
        End Function
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function FindByidordencompraExpr1(ByVal idordencompra As Integer, ByVal Expr1 As Integer) As ordencomprampRow
            Return CType(Me.Rows.Find(New Object() {idordencompra, Expr1}),ordencomprampRow)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New System.Data.UniqueConstraint("Constraint1", New System.Data.DataColumn() {Me.columnidordencompra, Me.columnExpr1}, true))
