...
#Region "Protected Members"
    ...
    Protected _fntTitleNormal As Font = New Font("Tahoma", 11, FontStyle.Regular, GraphicsUnit.Pixel)
    Protected _fntTitleHover As Font = New Font("Tahoma", 11, FontStyle.Bold, GraphicsUnit.Pixel)
    Protected _fntTextNormal As Font = New Font("Tahoma", 10, FontStyle.Regular, GraphicsUnit.Pixel)
    Protected _fntTextHover As Font = New Font("Tahoma", 10, FontStyle.Underline, GraphicsUnit.Pixel)
