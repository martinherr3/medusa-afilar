...
Module ModuloPrincipal
    ...
    'Public SQLBD As New frmBaseDatos
    Public seguridad As New ClsSeg


    Sub main()

        'cnn.ConnectionString = "workstation id=GERARDO;packet size=4096;integrated security=SSPI;initial catalog=Afilar;persist security info=False"
        Dim oBaseDatos As New BaseDatos
        cnn.ConnectionString = oBaseDatos.GetConection()
        oBaseDatos = Nothing

        System.Windows.Forms.Application.Run(princ)
        'System.Windows.Forms.Application.Run(SQLBD)
