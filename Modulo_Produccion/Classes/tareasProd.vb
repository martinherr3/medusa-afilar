...
Public Class tareasProd
  ...
  Public Sub New(ByVal idFresa As Integer, ByVal idEtapa As Integer, ByVal nombre As String, ByVal idMaquina As String, ByVal duracion As String, ByVal orden As Integer, ByVal tipo As String)
    _idFresa = idFresa
    _idEtapa = idEtapa
    _nombre = nombre
  ...
  Public Function getDSByIdfresa() As DataSet
    ...
    sql = "SELECT f.nroserie, e.idetapafabricacion, o.maquina, o.nombre, o.duracionpromedio, e.orden " & _
