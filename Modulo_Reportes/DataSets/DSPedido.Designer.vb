...
<System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 System.Xml.Serialization.XmlRootAttribute("DSPedido"),  _
...
Partial Public Class DSPedido
    ...
    Partial Public Class PedidoDataTable
        ...
        Public Overloads Function AddPedidoRow( _
                    ...
                    ByVal estado As String) As PedidoRow
            Dim rowPedidoRow As PedidoRow = CType(Me.NewRow,PedidoRow)
            rowPedidoRow.ItemArray = New Object() {idpedido, fechaentrega, fecharealizacion, idestado, prioridad, idcliente, idvendedor, idformadeentrega, idempresa, idviajante, fecharealentrega, nombreCliente, apellidoCliente, nombreEmpleado, apellidoEmpleado, estado}
    ...
    Partial Public Class PedidoRow
        ...
        Public Property nombreEmpleado() As String
            Get
                Try 
                    Return CType(Me(Me.tablePedido.nombreEmpleadoColumn),String)
                Catch e As System.InvalidCastException
                    Throw New System.Data.StrongTypingException("El valor de la columna 'nombreEmpleado' de la tabla 'Pedido' es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablePedido.nombreEmpleadoColumn) = value
            End Set
        End Property
        ...
        Public Property apellidoEmpleado() As String
            Get
                Try 
                    Return CType(Me(Me.tablePedido.apellidoEmpleadoColumn),String)
                Catch e As System.InvalidCastException
                    Throw New System.Data.StrongTypingException("El valor de la columna 'apellidoEmpleado' de la tabla 'Pedido' es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablePedido.apellidoEmpleadoColumn) = value
            End Set
        End Property
        ...
        Public Function IsnombreEmpleadoNull() As Boolean
            Return Me.IsNull(Me.tablePedido.nombreEmpleadoColumn)
        End Function
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetnombreEmpleadoNull()
            Me(Me.tablePedido.nombreEmpleadoColumn) = System.Convert.DBNull
        End Sub
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsapellidoEmpleadoNull() As Boolean
            Return Me.IsNull(Me.tablePedido.apellidoEmpleadoColumn)
        End Function
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetapellidoEmpleadoNull()
            Me(Me.tablePedido.apellidoEmpleadoColumn) = System.Convert.DBNull
        End Sub
...
Namespace DSPedidoTableAdapters
    ...
    Partial Public Class PedidoTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     cliente.nombre AS nombreCliente, cliente.apellido AS apellidoCliente, "& _ 
                "empleado.nombre AS nombreEmpleado, empleado.apellido AS apellidoEmpleado,"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"     "& _ 
                "                  estado.nombre AS estado, Pedido.*"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Pedido INNER J"& _ 
                "OIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      cliente ON Pedido.idcliente = cliente.idcliente INNER"& _ 
                " JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      empleado ON Pedido.idvendedor = empleado.idlegajo I"& _ 
                "NNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      estado ON Pedido.idestado = estado.idestado"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DSPedido.PedidoDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DSPedido.PedidoDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DSPedido.PedidoDataTable = New DSPedido.PedidoDataTable
